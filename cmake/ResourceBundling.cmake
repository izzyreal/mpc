...
function(_bundle_mpc_resources _target_name)
  ...
  _add_resource_files(${_target_name} ${_mpc_resources_root} fonts "fnt;bmp" "${total_list}")
...
function(_add_resource_files _target_name _rsrc_root_path _sub_dir _extensions _total_list)
...
function(_add_test_resource_files _target_name _rsrc_root_path _sub_dir _extensions _total_list)
  foreach(_extension IN LISTS _extensions)
    file(
      GLOB _list
      LIST_DIRECTORIES false
