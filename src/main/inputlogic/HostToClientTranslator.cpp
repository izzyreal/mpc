...
ClientInput HostToClientTranslator::translate(const HostInputEvent& hostEvent) {
    ...
    case HostInputEvent::MOUSE: {
        ...
        case MouseEvent::PAD1:
            clientEvent.index = 0;
            clientEvent.type = (mouse.type == MouseEvent::DOWN) ? ClientInput::Type::PadPress : (mouse.type == MouseEvent::UP) ? ClientInput::Type::PadRelease : ClientInput::Type::PadAftertouch;
        ...
        case MouseEvent::PLAY_BUTTON:
            ...
            clientEvent.type = (mouse.type == MouseEvent::DOWN) ? ClientInput::Type::ButtonPress : ClientInput::Type::ButtonRelease;
            break;
