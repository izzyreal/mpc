...
const std::map<const int, const VmpcKeyCode>
    KeyCodeHelper::platformToVmpcKeyCodes{
        ...
        {kVK_ANSI_KeypadDecimal,
         VmpcKeyCode::VMPC_KEY_ANSI_KeypadPeriodOrDelete},
        ...
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF1,
         VmpcKeyCode::VMPC_KEY_F1},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF2,
         VmpcKeyCode::VMPC_KEY_F2},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF3,
         VmpcKeyCode::VMPC_KEY_F3},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF4,
         VmpcKeyCode::VMPC_KEY_F4},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF5,
         VmpcKeyCode::VMPC_KEY_F5},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF6,
         VmpcKeyCode::VMPC_KEY_F6},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF7,
         VmpcKeyCode::VMPC_KEY_F7},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF8,
         VmpcKeyCode::VMPC_KEY_F8},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF9,
         VmpcKeyCode::VMPC_KEY_F9},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF10,
         VmpcKeyCode::VMPC_KEY_F10},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF11,
         VmpcKeyCode::VMPC_KEY_F11},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF12,
         VmpcKeyCode::VMPC_KEY_F12},

        {UIKeyConstants::UIKeyboardHIDUsageKeyboardEscape,
         VmpcKeyCode::VMPC_KEY_Escape},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardGraveAccentAndTilde,
         VmpcKeyCode::VMPC_KEY_ANSI_Grave},
        {0, VmpcKeyCode::VMPC_KEY_ISO_Section}, // No corresponding value
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardTab,
         VmpcKeyCode::VMPC_KEY_Tab},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardCapsLock,
         VmpcKeyCode::VMPC_KEY_CapsLock},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardLeftShift,
         VmpcKeyCode::VMPC_KEY_Shift},
        {0, VmpcKeyCode::VMPC_KEY_Function}, // No corresponding value
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardLeftControl,
         VmpcKeyCode::VMPC_KEY_Control},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardLeftAlt,
         VmpcKeyCode::VMPC_KEY_OptionOrAlt},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardLeftAlt,
         VmpcKeyCode::VMPC_KEY_LeftOptionOrAlt},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardRightAlt,
         VmpcKeyCode::VMPC_KEY_RightOptionOrAlt},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardLeftGUI,
         VmpcKeyCode::VMPC_KEY_LeftMeta},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardRightGUI,
         VmpcKeyCode::VMPC_KEY_RightMeta},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardHyphen,
         VmpcKeyCode::VMPC_KEY_ANSI_Minus},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardEqualSign,
         VmpcKeyCode::VMPC_KEY_ANSI_Equal},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardDeleteOrBackspace,
         VmpcKeyCode::VMPC_KEY_Delete},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardOpenBracket,
         VmpcKeyCode::VMPC_KEY_ANSI_LeftBracket},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardCloseBracket,
         VmpcKeyCode::VMPC_KEY_ANSI_RightBracket},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardBackslash,
         VmpcKeyCode::VMPC_KEY_ANSI_Backslash},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardSemicolon,
         VmpcKeyCode::VMPC_KEY_ANSI_Semicolon},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardQuote,
         VmpcKeyCode::VMPC_KEY_ANSI_Quote},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardReturnOrEnter,
         VmpcKeyCode::VMPC_KEY_Return},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardComma,
         VmpcKeyCode::VMPC_KEY_ANSI_Comma},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardPeriod,
         VmpcKeyCode::VMPC_KEY_ANSI_Period},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardSlash,
         VmpcKeyCode::VMPC_KEY_ANSI_Slash},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardRightShift,
         VmpcKeyCode::VMPC_KEY_RightShift},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardRightAlt,
         VmpcKeyCode::VMPC_KEY_RightOptionOrAlt},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardSpacebar,
         VmpcKeyCode::VMPC_KEY_Space},

        {UIKeyConstants::UIKeyboardHIDUsageKeypad0,
         VmpcKeyCode::VMPC_KEY_ANSI_Keypad0},
        {UIKeyConstants::UIKeyboardHIDUsageKeypad1,
         VmpcKeyCode::VMPC_KEY_ANSI_Keypad1},
        {UIKeyConstants::UIKeyboardHIDUsageKeypad2,
         VmpcKeyCode::VMPC_KEY_ANSI_Keypad2},
        {UIKeyConstants::UIKeyboardHIDUsageKeypad3,
         VmpcKeyCode::VMPC_KEY_ANSI_Keypad3},
        {UIKeyConstants::UIKeyboardHIDUsageKeypad4,
         VmpcKeyCode::VMPC_KEY_ANSI_Keypad4},
        {UIKeyConstants::UIKeyboardHIDUsageKeypad5,
         VmpcKeyCode::VMPC_KEY_ANSI_Keypad5},
        {UIKeyConstants::UIKeyboardHIDUsageKeypad6,
         VmpcKeyCode::VMPC_KEY_ANSI_Keypad6},
        {UIKeyConstants::UIKeyboardHIDUsageKeypad7,
         VmpcKeyCode::VMPC_KEY_ANSI_Keypad7},
        {UIKeyConstants::UIKeyboardHIDUsageKeypad8,
         VmpcKeyCode::VMPC_KEY_ANSI_Keypad8},
        {UIKeyConstants::UIKeyboardHIDUsageKeypad9,
         VmpcKeyCode::VMPC_KEY_ANSI_Keypad9},
        {UIKeyConstants::UIKeyboardHIDUsageKeypadNumLock,
         VmpcKeyCode::VMPC_KEY_ANSI_KeypadNumLockOrClear},
        {UIKeyConstants::UIKeyboardHIDUsageKeypadSlash,
         VmpcKeyCode::VMPC_KEY_ANSI_KeypadDivide},
        {UIKeyConstants::UIKeyboardHIDUsageKeypadAsterisk,
         VmpcKeyCode::VMPC_KEY_ANSI_KeypadMultiply},
        {UIKeyConstants::UIKeyboardHIDUsageKeypadHyphen,
         VmpcKeyCode::VMPC_KEY_ANSI_KeypadMinus},
        {UIKeyConstants::UIKeyboardHIDUsageKeypadPlus,
         VmpcKeyCode::VMPC_KEY_ANSI_KeypadPlus},
        {UIKeyConstants::UIKeyboardHIDUsageKeypadEnter,
         VmpcKeyCode::VMPC_KEY_ANSI_KeypadEnter},
        {UIKeyConstants::UIKeyboardHIDUsageKeypadPeriod,
         VmpcKeyCode::VMPC_KEY_ANSI_KeypadPeriodOrDelete},
        {UIKeyConstants::UIKeyboardHIDUsageKeypadEqualSign,
         VmpcKeyCode::VMPC_KEY_ANSI_KeypadEquals},
        {UIKeyConstants::UIKeyboardHIDUsageKeypadComma,
         VmpcKeyCode::VMPC_KEY_ANSI_KeypadComma},

        {UIKeyConstants::UIKeyboardHIDUsageKeyboard0,
         VmpcKeyCode::VMPC_KEY_ANSI_0},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboard1,
         VmpcKeyCode::VMPC_KEY_ANSI_1},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboard2,
         VmpcKeyCode::VMPC_KEY_ANSI_2},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboard3,
         VmpcKeyCode::VMPC_KEY_ANSI_3},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboard4,
         VmpcKeyCode::VMPC_KEY_ANSI_4},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboard5,
         VmpcKeyCode::VMPC_KEY_ANSI_5},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboard6,
         VmpcKeyCode::VMPC_KEY_ANSI_6},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboard7,
         VmpcKeyCode::VMPC_KEY_ANSI_7},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboard8,
         VmpcKeyCode::VMPC_KEY_ANSI_8},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboard9,
         VmpcKeyCode::VMPC_KEY_ANSI_9},

        {UIKeyConstants::UIKeyboardHIDUsageKeyboardQ,
         VmpcKeyCode::VMPC_KEY_ANSI_Q},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardW,
         VmpcKeyCode::VMPC_KEY_ANSI_W},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardE,
         VmpcKeyCode::VMPC_KEY_ANSI_E},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardR,
         VmpcKeyCode::VMPC_KEY_ANSI_R},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardT,
         VmpcKeyCode::VMPC_KEY_ANSI_T},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardY,
         VmpcKeyCode::VMPC_KEY_ANSI_Y},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardU,
         VmpcKeyCode::VMPC_KEY_ANSI_U},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardI,
         VmpcKeyCode::VMPC_KEY_ANSI_I},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardO,
         VmpcKeyCode::VMPC_KEY_ANSI_O},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardP,
         VmpcKeyCode::VMPC_KEY_ANSI_P},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardA,
         VmpcKeyCode::VMPC_KEY_ANSI_A},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardS,
         VmpcKeyCode::VMPC_KEY_ANSI_S},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardD,
         VmpcKeyCode::VMPC_KEY_ANSI_D},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardF,
         VmpcKeyCode::VMPC_KEY_ANSI_F},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardG,
         VmpcKeyCode::VMPC_KEY_ANSI_G},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardH,
         VmpcKeyCode::VMPC_KEY_ANSI_H},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardJ,
         VmpcKeyCode::VMPC_KEY_ANSI_J},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardK,
         VmpcKeyCode::VMPC_KEY_ANSI_K},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardL,
         VmpcKeyCode::VMPC_KEY_ANSI_L},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardZ,
         VmpcKeyCode::VMPC_KEY_ANSI_Z},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardX,
         VmpcKeyCode::VMPC_KEY_ANSI_X},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardC,
         VmpcKeyCode::VMPC_KEY_ANSI_C},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardV,
         VmpcKeyCode::VMPC_KEY_ANSI_V},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardB,
         VmpcKeyCode::VMPC_KEY_ANSI_B},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardN,
         VmpcKeyCode::VMPC_KEY_ANSI_N},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardM,
         VmpcKeyCode::VMPC_KEY_ANSI_M},

        {UIKeyConstants::UIKeyboardHIDUsageKeyboardLeftArrow,
         VmpcKeyCode::VMPC_KEY_LeftArrow},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardRightArrow,
         VmpcKeyCode::VMPC_KEY_RightArrow},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardUpArrow,
         VmpcKeyCode::VMPC_KEY_UpArrow},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardDownArrow,
         VmpcKeyCode::VMPC_KEY_DownArrow},

        {UIKeyConstants::UIKeyboardHIDUsageKeyboardHome,
         VmpcKeyCode::VMPC_KEY_Home},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardPageUp,
         VmpcKeyCode::VMPC_KEY_PageUp},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardEnd,
         VmpcKeyCode::VMPC_KEY_End},
        {UIKeyConstants::UIKeyboardHIDUsageKeyboardPageDown,
         VmpcKeyCode::VMPC_KEY_PageDown}
        ...
        {AKEYCODE_F1, VmpcKeyCode::VMPC_KEY_F1},
        {AKEYCODE_F2, VmpcKeyCode::VMPC_KEY_F2},
        {AKEYCODE_F3, VmpcKeyCode::VMPC_KEY_F3},
        {AKEYCODE_F4, VmpcKeyCode::VMPC_KEY_F4},
        {AKEYCODE_F5, VmpcKeyCode::VMPC_KEY_F5},
        {AKEYCODE_F6, VmpcKeyCode::VMPC_KEY_F6},
        {AKEYCODE_F7, VmpcKeyCode::VMPC_KEY_F7},
        {AKEYCODE_F8, VmpcKeyCode::VMPC_KEY_F8},
        {AKEYCODE_F9, VmpcKeyCode::VMPC_KEY_F9},
        {AKEYCODE_F10, VmpcKeyCode::VMPC_KEY_F10},
        {AKEYCODE_F11, VmpcKeyCode::VMPC_KEY_F11},
        {AKEYCODE_F12, VmpcKeyCode::VMPC_KEY_F12},

        {AKEYCODE_ESCAPE, VmpcKeyCode::VMPC_KEY_Escape},
        {AKEYCODE_GRAVE, VmpcKeyCode::VMPC_KEY_ANSI_Grave},
        {AKEYCODE_TAB, VmpcKeyCode::VMPC_KEY_Tab},
        {AKEYCODE_CAPS_LOCK, VmpcKeyCode::VMPC_KEY_CapsLock},
        {AKEYCODE_SHIFT_LEFT, VmpcKeyCode::VMPC_KEY_Shift},
        {AKEYCODE_SHIFT_RIGHT, VmpcKeyCode::VMPC_KEY_RightShift},
        {AKEYCODE_CTRL_LEFT, VmpcKeyCode::VMPC_KEY_Control},
        {AKEYCODE_CTRL_RIGHT, VmpcKeyCode::VMPC_KEY_RightControl},
        {AKEYCODE_ALT_LEFT, VmpcKeyCode::VMPC_KEY_OptionOrAlt},
        {AKEYCODE_ALT_RIGHT, VmpcKeyCode::VMPC_KEY_RightOptionOrAlt},
        {AKEYCODE_META_LEFT, VmpcKeyCode::VMPC_KEY_LeftMeta},
        {AKEYCODE_META_RIGHT, VmpcKeyCode::VMPC_KEY_RightMeta},
        {AKEYCODE_FUNCTION, VmpcKeyCode::VMPC_KEY_Function},
        {AKEYCODE_MINUS, VmpcKeyCode::VMPC_KEY_ANSI_Minus},
        {AKEYCODE_EQUALS, VmpcKeyCode::VMPC_KEY_ANSI_Equal},
        {AKEYCODE_FORWARD_DEL, VmpcKeyCode::VMPC_KEY_Delete},
        {AKEYCODE_INSERT, VmpcKeyCode::VMPC_KEY_Insert},
        {AKEYCODE_DEL, VmpcKeyCode::VMPC_KEY_Backspace},
        {AKEYCODE_LEFT_BRACKET, VmpcKeyCode::VMPC_KEY_ANSI_LeftBracket},
        {AKEYCODE_RIGHT_BRACKET, VmpcKeyCode::VMPC_KEY_ANSI_RightBracket},
        {AKEYCODE_BACKSLASH, VmpcKeyCode::VMPC_KEY_ANSI_Backslash},
        {AKEYCODE_SEMICOLON, VmpcKeyCode::VMPC_KEY_ANSI_Semicolon},
        {AKEYCODE_APOSTROPHE, VmpcKeyCode::VMPC_KEY_ANSI_Quote},
        {AKEYCODE_ENTER, VmpcKeyCode::VMPC_KEY_Return},
        {AKEYCODE_COMMA, VmpcKeyCode::VMPC_KEY_ANSI_Comma},
        {AKEYCODE_PERIOD, VmpcKeyCode::VMPC_KEY_ANSI_Period},
        {AKEYCODE_SLASH, VmpcKeyCode::VMPC_KEY_ANSI_Slash},
        {AKEYCODE_SPACE, VmpcKeyCode::VMPC_KEY_Space},

        {AKEYCODE_0, VmpcKeyCode::VMPC_KEY_ANSI_0},
        {AKEYCODE_1, VmpcKeyCode::VMPC_KEY_ANSI_1},
        {AKEYCODE_2, VmpcKeyCode::VMPC_KEY_ANSI_2},
        {AKEYCODE_3, VmpcKeyCode::VMPC_KEY_ANSI_3},
        {AKEYCODE_4, VmpcKeyCode::VMPC_KEY_ANSI_4},
        {AKEYCODE_5, VmpcKeyCode::VMPC_KEY_ANSI_5},
        {AKEYCODE_6, VmpcKeyCode::VMPC_KEY_ANSI_6},
        {AKEYCODE_7, VmpcKeyCode::VMPC_KEY_ANSI_7},
        {AKEYCODE_8, VmpcKeyCode::VMPC_KEY_ANSI_8},
        {AKEYCODE_9, VmpcKeyCode::VMPC_KEY_ANSI_9},

        {AKEYCODE_A, VmpcKeyCode::VMPC_KEY_ANSI_A},
        {AKEYCODE_B, VmpcKeyCode::VMPC_KEY_ANSI_B},
        {AKEYCODE_C, VmpcKeyCode::VMPC_KEY_ANSI_C},
        {AKEYCODE_D, VmpcKeyCode::VMPC_KEY_ANSI_D},
        {AKEYCODE_E, VmpcKeyCode::VMPC_KEY_ANSI_E},
        {AKEYCODE_F, VmpcKeyCode::VMPC_KEY_ANSI_F},
        {AKEYCODE_G, VmpcKeyCode::VMPC_KEY_ANSI_G},
        {AKEYCODE_H, VmpcKeyCode::VMPC_KEY_ANSI_H},
        {AKEYCODE_I, VmpcKeyCode::VMPC_KEY_ANSI_I},
        {AKEYCODE_J, VmpcKeyCode::VMPC_KEY_ANSI_J},
        {AKEYCODE_K, VmpcKeyCode::VMPC_KEY_ANSI_K},
        {AKEYCODE_L, VmpcKeyCode::VMPC_KEY_ANSI_L},
        {AKEYCODE_M, VmpcKeyCode::VMPC_KEY_ANSI_M},
        {AKEYCODE_N, VmpcKeyCode::VMPC_KEY_ANSI_N},
        {AKEYCODE_O, VmpcKeyCode::VMPC_KEY_ANSI_O},
        {AKEYCODE_P, VmpcKeyCode::VMPC_KEY_ANSI_P},
        {AKEYCODE_Q, VmpcKeyCode::VMPC_KEY_ANSI_Q},
        {AKEYCODE_R, VmpcKeyCode::VMPC_KEY_ANSI_R},
        {AKEYCODE_S, VmpcKeyCode::VMPC_KEY_ANSI_S},
        {AKEYCODE_T, VmpcKeyCode::VMPC_KEY_ANSI_T},
        {AKEYCODE_U, VmpcKeyCode::VMPC_KEY_ANSI_U},
        {AKEYCODE_V, VmpcKeyCode::VMPC_KEY_ANSI_V},
        {AKEYCODE_W, VmpcKeyCode::VMPC_KEY_ANSI_W},
        {AKEYCODE_X, VmpcKeyCode::VMPC_KEY_ANSI_X},
        {AKEYCODE_Y, VmpcKeyCode::VMPC_KEY_ANSI_Y},
        {AKEYCODE_Z, VmpcKeyCode::VMPC_KEY_ANSI_Z},

        {AKEYCODE_DPAD_LEFT, VmpcKeyCode::VMPC_KEY_LeftArrow},
        {AKEYCODE_DPAD_RIGHT, VmpcKeyCode::VMPC_KEY_RightArrow},
        {AKEYCODE_DPAD_UP, VmpcKeyCode::VMPC_KEY_UpArrow},
        {AKEYCODE_DPAD_DOWN, VmpcKeyCode::VMPC_KEY_DownArrow},

        {AKEYCODE_MOVE_HOME, VmpcKeyCode::VMPC_KEY_Home},
        {AKEYCODE_PAGE_UP, VmpcKeyCode::VMPC_KEY_PageUp},
        {AKEYCODE_MOVE_END, VmpcKeyCode::VMPC_KEY_End},
        {AKEYCODE_PAGE_DOWN, VmpcKeyCode::VMPC_KEY_PageDown},

        {AKEYCODE_NUMPAD_0, VmpcKeyCode::VMPC_KEY_ANSI_Keypad0},
        {AKEYCODE_NUMPAD_1, VmpcKeyCode::VMPC_KEY_ANSI_Keypad1},
        {AKEYCODE_NUMPAD_2, VmpcKeyCode::VMPC_KEY_ANSI_Keypad2},
        {AKEYCODE_NUMPAD_3, VmpcKeyCode::VMPC_KEY_ANSI_Keypad3},
        {AKEYCODE_NUMPAD_4, VmpcKeyCode::VMPC_KEY_ANSI_Keypad4},
        {AKEYCODE_NUMPAD_5, VmpcKeyCode::VMPC_KEY_ANSI_Keypad5},
        {AKEYCODE_NUMPAD_6, VmpcKeyCode::VMPC_KEY_ANSI_Keypad6},
        {AKEYCODE_NUMPAD_7, VmpcKeyCode::VMPC_KEY_ANSI_Keypad7},
        {AKEYCODE_NUMPAD_8, VmpcKeyCode::VMPC_KEY_ANSI_Keypad8},
        {AKEYCODE_NUMPAD_9, VmpcKeyCode::VMPC_KEY_ANSI_Keypad9},
        {AKEYCODE_NUMPAD_DOT, VmpcKeyCode::VMPC_KEY_ANSI_KeypadPeriodOrDelete},
        {AKEYCODE_NUMPAD_MULTIPLY, VmpcKeyCode::VMPC_KEY_ANSI_KeypadMultiply},
        {AKEYCODE_NUMPAD_ADD, VmpcKeyCode::VMPC_KEY_ANSI_KeypadPlus},
        {AKEYCODE_NUM_LOCK, VmpcKeyCode::VMPC_KEY_ANSI_KeypadNumLockOrClear},
        {AKEYCODE_NUMPAD_DIVIDE, VmpcKeyCode::VMPC_KEY_ANSI_KeypadDivide},
        {AKEYCODE_NUMPAD_ENTER, VmpcKeyCode::VMPC_KEY_ANSI_KeypadEnter},
        {AKEYCODE_NUMPAD_SUBTRACT, VmpcKeyCode::VMPC_KEY_ANSI_KeypadMinus},
        {AKEYCODE_NUMPAD_EQUALS, VmpcKeyCode::VMPC_KEY_ANSI_KeypadEquals},
        {AKEYCODE_NUMPAD_COMMA, VmpcKeyCode::VMPC_KEY_ANSI_KeypadComma}
...
const std::map<const VmpcKeyCode, const char>
    KeyCodeHelper::typableVmpcKeyCodes{{VmpcKeyCode::VMPC_KEY_ANSI_0, '0'},
...
KeyCodeHelper::getAsciiCompatibleDisplayName(const VmpcKeyCode vmpcKeyCode)
{
    const auto commonDescriptor =
        getDescriptorIfCommonForAsciiAndUnicode(vmpcKeyCode);
    ...
    {
        // Bespoke descriptors for keys that don't produce characters.
        // Below descriptors are only used for simple ASCII-based display, like
        // the virtual MPC2000XL's LCD screen.
        ...
        // Keys that produce characters, but a descriptor should be used as
        // display name
        ...
        default:
            ...
            if (static_cast<int>(vmpcKeyCode) >=
                    static_cast<int>(VmpcKeyCode::VMPC_KEY_ANSI_Keypad0) &&
                static_cast<int>(vmpcKeyCode) <=
                    static_cast<int>(VmpcKeyCode::VMPC_KEY_ANSI_KeypadComma))
            {
                result += " (numpad)";
            }
    ...
    if (result.size() == 2)
    {
        result = std::string(1, result.front()) + " (or " +
                 std::string(1, result.back()) + " with Shift)";
    }
...
std::optional<char>
KeyCodeHelper::getCharWithShiftModifier(const VmpcKeyCode vmpcKeyCode)
{
    ...
    if (auto character = keyCodeInfo.charWithShiftModifier;
        character.length() == 1)
    {
        return character[0];
    }
