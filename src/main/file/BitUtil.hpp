...
namespace mpc::file
{
    ...
    public:
        ...
        removeUnusedBits(unsigned char b, const std::vector<int> &usedRange);
        static std::vector<int> invertRange(const std::vector<int> &range);
        ...
        static unsigned char stitchBytes(unsigned char b1,
                                         const std::vector<int> &usedBits1,
                                         unsigned char b2,
                                         const std::vector<int> &usedBits2);
