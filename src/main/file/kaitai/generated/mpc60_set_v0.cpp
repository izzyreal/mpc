...
#include "mpc60_set_v0.h"
#include "kaitai/exceptions.h"
#include <cstddef>
#include <stdexcept>
const std::set<mpc60_set_v0_t::analog_output_jack_t> mpc60_set_v0_t::_values_analog_output_jack_t{
    mpc60_set_v0_t::ANALOG_OUTPUT_JACK_FALSE,
    mpc60_set_v0_t::ANALOG_OUTPUT_JACK_JACK_1,
    mpc60_set_v0_t::ANALOG_OUTPUT_JACK_JACK_2,
    mpc60_set_v0_t::ANALOG_OUTPUT_JACK_JACK_3,
    mpc60_set_v0_t::ANALOG_OUTPUT_JACK_JACK_4,
    mpc60_set_v0_t::ANALOG_OUTPUT_JACK_JACK_5,
    mpc60_set_v0_t::ANALOG_OUTPUT_JACK_JACK_6,
    mpc60_set_v0_t::ANALOG_OUTPUT_JACK_JACK_7,
    mpc60_set_v0_t::ANALOG_OUTPUT_JACK_JACK_8,
};
bool mpc60_set_v0_t::_is_defined_analog_output_jack_t(mpc60_set_v0_t::analog_output_jack_t v) {
    return mpc60_set_v0_t::_values_analog_output_jack_t.find(v) != mpc60_set_v0_t::_values_analog_output_jack_t.end();
}
const std::set<mpc60_set_v0_t::filter_range_t> mpc60_set_v0_t::_values_filter_range_t{
    mpc60_set_v0_t::FILTER_RANGE_LESS_THAN_OR_EQUALS_47_KHZ,
    mpc60_set_v0_t::FILTER_RANGE_GREATER_THAN_47_KHZ,
};
bool mpc60_set_v0_t::_is_defined_filter_range_t(mpc60_set_v0_t::filter_range_t v) {
    return mpc60_set_v0_t::_values_filter_range_t.find(v) != mpc60_set_v0_t::_values_filter_range_t.end();
}
const std::set<mpc60_set_v0_t::mpc60_pad_t> mpc60_set_v0_t::_values_mpc60_pad_t{
    mpc60_set_v0_t::MPC60_PAD_HIHT_CLSD,
    mpc60_set_v0_t::MPC60_PAD_HIHT_MEDM,
    mpc60_set_v0_t::MPC60_PAD_HIHT_OPEN,
    mpc60_set_v0_t::MPC60_PAD_SNR1,
    mpc60_set_v0_t::MPC60_PAD_SNR2,
    mpc60_set_v0_t::MPC60_PAD_BASS,
    mpc60_set_v0_t::MPC60_PAD_TOM1,
    mpc60_set_v0_t::MPC60_PAD_TOM2,
    mpc60_set_v0_t::MPC60_PAD_TOM3,
    mpc60_set_v0_t::MPC60_PAD_TOM4,
    mpc60_set_v0_t::MPC60_PAD_RID1,
    mpc60_set_v0_t::MPC60_PAD_RID2,
    mpc60_set_v0_t::MPC60_PAD_CRS1,
    mpc60_set_v0_t::MPC60_PAD_CRS2,
    mpc60_set_v0_t::MPC60_PAD_PRC1,
    mpc60_set_v0_t::MPC60_PAD_PRC2,
    mpc60_set_v0_t::MPC60_PAD_PRC3,
    mpc60_set_v0_t::MPC60_PAD_PRC4,
    mpc60_set_v0_t::MPC60_PAD_DR01,
    mpc60_set_v0_t::MPC60_PAD_DR02,
    mpc60_set_v0_t::MPC60_PAD_DR03,
    mpc60_set_v0_t::MPC60_PAD_DR04,
    mpc60_set_v0_t::MPC60_PAD_DR05,
    mpc60_set_v0_t::MPC60_PAD_DR06,
    mpc60_set_v0_t::MPC60_PAD_DR07,
    mpc60_set_v0_t::MPC60_PAD_DR08,
    mpc60_set_v0_t::MPC60_PAD_DR09,
    mpc60_set_v0_t::MPC60_PAD_DR10,
    mpc60_set_v0_t::MPC60_PAD_DR11,
    mpc60_set_v0_t::MPC60_PAD_DR12,
    mpc60_set_v0_t::MPC60_PAD_DR13,
    mpc60_set_v0_t::MPC60_PAD_DR14,
    mpc60_set_v0_t::MPC60_PAD_DR15,
    mpc60_set_v0_t::MPC60_PAD_DR16,
};
bool mpc60_set_v0_t::_is_defined_mpc60_pad_t(mpc60_set_v0_t::mpc60_pad_t v) {
    return mpc60_set_v0_t::_values_mpc60_pad_t.find(v) != mpc60_set_v0_t::_values_mpc60_pad_t.end();
}
const std::set<mpc60_set_v0_t::normal_or_hihat_t> mpc60_set_v0_t::_values_normal_or_hihat_t{
    mpc60_set_v0_t::NORMAL_OR_HIHAT_NORMAL,
    mpc60_set_v0_t::NORMAL_OR_HIHAT_HIHAT,
};
bool mpc60_set_v0_t::_is_defined_normal_or_hihat_t(mpc60_set_v0_t::normal_or_hihat_t v) {
    return mpc60_set_v0_t::_values_normal_or_hihat_t.find(v) != mpc60_set_v0_t::_values_normal_or_hihat_t.end();
}
const std::set<mpc60_set_v0_t::use_master_mix_data_t> mpc60_set_v0_t::_values_use_master_mix_data_t{
    mpc60_set_v0_t::USE_MASTER_MIX_DATA_IGNORE,
    mpc60_set_v0_t::USE_MASTER_MIX_DATA_USE,
};
bool mpc60_set_v0_t::_is_defined_use_master_mix_data_t(mpc60_set_v0_t::use_master_mix_data_t v) {
    return mpc60_set_v0_t::_values_use_master_mix_data_t.find(v) != mpc60_set_v0_t::_values_use_master_mix_data_t.end();
}

mpc60_set_v0_t::mpc60_set_v0_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, mpc60_set_v0_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root ? p__root : this;
    m__dirty = false;
}

void mpc60_set_v0_t::_read() {
    ...
    m_use_master_mix_data = static_cast<mpc60_set_v0_t::use_master_mix_data_t>(m__io->read_u1());
...
void mpc60_set_v0_t::_fetch_instances() {
...
mpc60_set_v0_t::~mpc60_set_v0_t() {}

mpc60_set_v0_t::sound_directory_entry_t::sound_directory_entry_t(kaitai::kstream* p__io, mpc60_set_v0_t* p__parent, mpc60_set_v0_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    m__dirty = false;
}

void mpc60_set_v0_t::sound_directory_entry_t::_read() {
    ...
    m_analog_output_jack = static_cast<mpc60_set_v0_t::analog_output_jack_t>(m__io->read_u1());
...
void mpc60_set_v0_t::sound_directory_entry_t::_fetch_instances() {
    m_sound_characteristics.get()->_fetch_instances();
}

void mpc60_set_v0_t::sound_directory_entry_t::_write() {
...
void mpc60_set_v0_t::sound_directory_entry_t::_check() {
...
mpc60_set_v0_t::sound_directory_entry_t::~sound_directory_entry_t() {}

mpc60_set_v0_t::sound_directory_entry_t::sound_characteristics_t::sound_characteristics_t(kaitai::kstream* p__io, mpc60_set_v0_t::sound_directory_entry_t* p__parent, mpc60_set_v0_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    m__dirty = false;
}

void mpc60_set_v0_t::sound_directory_entry_t::sound_characteristics_t::_read() {
    m_normal_or_hihat_sound = static_cast<mpc60_set_v0_t::normal_or_hihat_t>(m__io->read_bits_int_le(1));
    m_save_required = m__io->read_bits_int_le(1);
    m__unnamed2 = m__io->read_bits_int_le(5);
    m_filter = static_cast<mpc60_set_v0_t::filter_range_t>(m__io->read_bits_int_le(1));
    m__dirty = false;
}

void mpc60_set_v0_t::sound_directory_entry_t::sound_characteristics_t::_fetch_instances() {
}

void mpc60_set_v0_t::sound_directory_entry_t::sound_characteristics_t::_write() {
...
void mpc60_set_v0_t::sound_directory_entry_t::sound_characteristics_t::_check() {
    m__dirty = false;
}

mpc60_set_v0_t::sound_directory_entry_t::sound_characteristics_t::~sound_characteristics_t() {}

mpc60_set_v0_t::u3le_t::u3le_t(kaitai::kstream* p__io, mpc60_set_v0_t* p__parent, mpc60_set_v0_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    m__dirty = false;
    f_value = false;
...
void mpc60_set_v0_t::u3le_t::_read() {
    m_b12 = m__io->read_u2le();
    m_b3 = m__io->read_u1();
    m__dirty = false;
}

void mpc60_set_v0_t::u3le_t::_fetch_instances() {
}

void mpc60_set_v0_t::u3le_t::_write() {
...
void mpc60_set_v0_t::u3le_t::_check() {
    m__dirty = false;
}

mpc60_set_v0_t::u3le_t::~u3le_t() {}

int32_t mpc60_set_v0_t::u3le_t::value() {
    if (f_value)
        return m_value;
    f_value = true;
    m_value = b12() | b3() << 16;
