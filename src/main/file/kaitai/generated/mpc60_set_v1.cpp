...
void mpc60_set_v1_t::_read() {
    ...
    if (!(m_file_format_version == std::string("\x01", 1))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x01", 1), m_file_format_version, m__io, std::string("/seq/1"));
    }
