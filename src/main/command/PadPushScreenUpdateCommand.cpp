#include "PadPushScreenUpdateCommand.h"
...
PadPushScreenUpdateCommand::PadPushScreenUpdateCommand(controls::PadPushScreenUpdateContext &ctxToUse, const int noteToUse, const std::optional<int> padIndexWithBankToUse)
    : ctx(ctxToUse), note(noteToUse), padIndexWithBank(padIndexWithBankToUse)
{
}

void PadPushScreenUpdateCommand::execute()
{
