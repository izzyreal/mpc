...
PadPushCommand::PadPushCommand(PadPushContext &ctx, int padIndexWithBank, int velo)
    : ctx(ctx), padIndexWithBank(padIndexWithBank), velo(velo)
{
}

void PadPushCommand::execute()
{
    ...
    PadPushScreenUpdateContext padPushScreenUpdateCtx {
    ...
    PadPushScreenUpdateCommand(padPushScreenUpdateCtx, note, padIndexWithBank).execute();

    generateNoteOn(ctx, note, velo, padIndexWithBank);
}

void PadPushCommand::generateNoteOn(const PadPushContext &ctx, const int note, const int velo, const int padIndexWithBank)
{
