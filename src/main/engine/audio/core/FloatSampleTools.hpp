...
namespace mpc::engine::audio::core {
	...
	public:
		static void byte2float(std::vector<char>& input, int inByteOffset, std::vector<std::valarray<float>>& output, int outOffset, int frameCount, AudioFormat* format);

    public:
		static void byte2floatGeneric(std::vector<char>& input, int inByteOffset, int inByteStep, std::valarray<float>& output, int outOffset, int sampleCount, AudioFormat* format);
		static void byte2floatGeneric(std::vector<char>& input, int inByteOffset, int inByteStep, std::valarray<float>& output, int outOffset, int sampleCount, int formatType);
	...
	public:
		static void float2byte(std::vector<std::valarray<float>>& input, int inOffset, std::vector<char>& output, int outByteOffset, int frameCount, AudioFormat* format, float ditherBits);

    public:
		static void float2byteGeneric(std::valarray<float>& input, int inOffset, std::vector<char>& output, int outByteOffset, int outByteStep, int sampleCount, AudioFormat* format, float ditherBits);
		static void float2byteGeneric(std::valarray<float>& input, int inOffset, std::vector<char>& output, int outByteOffset, int outByteStep, int sampleCount, int formatType, float ditherBits);
    };
}
