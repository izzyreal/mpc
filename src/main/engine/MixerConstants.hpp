...
namespace mpc::engine
{
    ...
    static constexpr int PhysicalSoundsStripIndex = 37;
    static constexpr int TotalMixerStripCount = 37;
    ...
    const std::string PhysicalSoundsStrip =
        std::to_string(PhysicalSoundsStripIndex);
}
