...
namespace mpc::sequencer
{
    ...
    public:
        ...
        /**
         * Processes musical position information that is not generated by
         * VMPC2000XL, typically a plugin host.
         */
        void processBufferExternal(
            const double hostPositionAtStartOfBufferQuarterNotes,
            const int nFrames, const int sampleRate, const double bpm,
            const int64_t timeInSamples);

        /**
         * Generates musical position information in the absence of a host or
         * another clock source. This is typically used by VMPC2000XL in its
         * standalone for.
         */
        void processBufferInternal(const float tempo, const uint32_t sampleRate,
