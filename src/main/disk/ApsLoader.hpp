...
namespace mpc::disk
{
    ...
    private:
        ...
        static void loadSound(mpc::Mpc &, std::string soundFileName,
                              std::string ext, std::weak_ptr<MpcFile> soundFile,
                              bool headless = false);
        static void showPopup(mpc::Mpc &, std::string name, std::string ext,
                              int sampleSize);
    };
} // namespace mpc::disk
