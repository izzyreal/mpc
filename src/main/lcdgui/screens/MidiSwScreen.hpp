...
private:
    ...
    const std::vector<std::string> functionNames{ "OFF", "PLAY STRT", "PLAY", "STOP", "REC+PLAY", "ODUB+PLAY", "REC/PUNCH", "ODUB/PNCH", "TAP", "PAD BNK A", "PAD BNK B", "PAD BNK C", "PAD BNK D", " PAD   1", " PAD   2", " PAD   3", " PAD   4", " PAD   5", " PAD   6", " PAD   7", " PAD   8", " PAD   9", " PAD  10", " PAD  11", " PAD  12", " PAD  13", " PAD  14", " PAD  15", " PAD  16", "   F1", "   F2", "   F3", "   F4", "   F5", "   F6" };
};
}
