...
namespace mpc::lcdgui
{
    class MixerStrip : public Component
    {
        ...
        const std::vector<int> xPos0indiv{5,   20,  35,  50,  65,  80,
                                          ...
                                          185, 200, 215, 230};
        const std::vector<int> xPos1indiv{12,  27,  42,  57,  72,  87,
                                          102, 117, 132, 147, 162, 177,
                                          192, 207, 222, 237};
        const std::vector<int> xPos0fx{5,   20,  35,  50,  65,  80,  95,  110,
                                       125, 140, 155, 170, 185, 200, 215, 230};
        const std::vector<int> xPos1fx{11,  26,  41,  56,  71,  86,  101, 116,
