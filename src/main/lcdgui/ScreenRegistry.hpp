...
#define SCREEN_LIST                                                            \
    ...
    X(screens::window, TransmitProgramChangesScreen,                           \
    ...
    X(screens::window, AutoChromaticAssignmentScreen,                          \
