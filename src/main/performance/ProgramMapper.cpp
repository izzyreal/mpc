        ...
        mpc::performance::Program& dst)
{
    for (int i = 0; i < 64; ++i)
    {
        ...
        dn.indivFxMixer.individualOutLevel = DrumMixerLevel(fx->getVolumeIndividualOut());
        dn.indivFxMixer.fxSendLevel        = DrumMixerLevel(fx->getFxSendLevel());
        dn.indivFxMixer.individualOutput   = DrumMixerIndividualOutput(fx->getOutput());
        ...
        dn.voiceOverlapMode           = static_cast<int8_t>(sn->getVoiceOverlapMode());
